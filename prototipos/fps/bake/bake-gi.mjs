...
const AL = { wood: [0.62, 0.42, 0.26], stone: [0.52, 0.5, 0.56], chimney: [0.3, 0.26, 0.3], stall: [0.3, 0.72, 0.62], arch: [0.5, 0.5, 0.55] };
const box = (tx, ty, kind, h) => ({ x0: tx, y0: ty, x1: tx + 1, y1: ty + 1, z1: h, al: AL[kind] });
const BOXES = [
  box(43, 12, 'wood', 1.75), box(44, 12, 'wood', 1.75), box(43, 13, 'wood', 1.75), box(42, 12, 'wood', 0.85),
  box(48, 12, 'stone', 1.35), box(49, 12, 'chimney', 2.05), box(49, 13, 'stone', 1.35), box(50, 12, 'stone', 0.8),
  box(43, 19, 'wood', 0.95), box(44, 19, 'wood', 0.95), box(43, 18, 'wood', 0.95), box(42, 19, 'wood', 0.7),
  box(48, 19, 'wood', 1.1), box(49, 19, 'wood', 1.1), box(49, 18, 'wood', 1.1), box(50, 19, 'stall', 0.6),
  box(45, 12, 'stall', 0.62), box(47, 12, 'stall', 0.62), box(46, 19, 'stall', 0.62),
  /* arcos do Hall de Portais: lâminas finas de pedra */
  { x0: 50.28, y0: 13.0, x1: 50.52, y1: 13.8, z1: 1.5, al: AL.arch },
  { x0: 50.98, y0: 15.2, x1: 51.22, y1: 16.0, z1: 1.6, al: AL.arch },
  { x0: 50.28, y0: 17.4, x1: 50.52, y1: 18.2, z1: 1.5, al: AL.arch },
];
