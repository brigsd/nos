...
**▶ [Abrir O Coração](https://brigsd.github.io/nos/fps/)** — PC ou celular, sem instalar nada. Primeira pessoa: **WASD** anda, **clique** captura o mouse para mirar (**ESC** solta e abre o menu), **←→**/arrastar também olham, **M** cicla o mapa (minimapa → mapa grande com setores), **I** liga as tags de identificação, **G** alterna a iluminação global. Siga o carreiro de terra até **A Clareira**, a cidade-oficina: quatro oficinas de telhado de cobre oxidado ao redor de um chafariz de três níveis, com o Portal do Átrio ao fundo. O [mapa 2D](https://brigsd.github.io/nos/) é a visão de cima do mesmo mundo, com os painéis (Mural, Comércio, Nativos, Portais).
