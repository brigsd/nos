...
## v2.5 — R4 · Motor de fabricação (A Fábrica) — 🚧 PR ABERTO, aguardando review (2026-07-15)
Fatia engine-first do D-24 roadmap (trilho R4), seguindo os fechamentos de design do D-25a. PR `claude/r4-fabricacao`, **não mesclado ainda**.
...
- **Tela (mínimo desta fatia):** Mural narra `item_synthesized` ("@login sintetizou 1 lanterna na Bancada") - 4ª voz do padrão já existente. Painel de Oficinas fica para a próxima fatia.
