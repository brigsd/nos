...
11. `[ ]` Modos livres do pincel: raio, dureza, degradê. Acrescenta, não substitui. **Inclui agora (transferido do passo 9, D-88) a base de textura pintável: projeção em caixa / atlas por face + a textura gerada ao abrir** — o pré-requisito real do pincel macio; o modo "face" do passo 9 já roda pelo swatch e migra pra essa textura aqui sem trocar o formato salvo (`['pincel',...]`).
