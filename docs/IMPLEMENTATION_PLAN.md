...
- [ ] C1 · A Cidade da Clareira — **proposta pronta em `docs/CIDADE.md`** (vila-oficina atemporal: largo + 4 alas de sintetizadores + lojas-feira + arcos de portais na borda leste; chão plano, verticalidade na arquitetura), aguardando sign-off estético e as 3 respostas do ideador (telhados, veias de luz, nome). Substitui o plano antigo da cidade 2D (branch `claude/cidade-coracao`, arte reprovada — fica como referência histórica até o Tiago apagar)
