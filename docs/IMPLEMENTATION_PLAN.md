...
- [ ] F17 · **Formato PLANTA (D-50, planejado)**: blueprint declarativo de estrutura (paredes/colisões/billboards num objeto) que o motor instancia — a prancheta é a metade de leitura; a escrita fecha o ciclo criar→auditar
