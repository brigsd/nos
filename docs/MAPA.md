...
- `oficina.html` — oficina.html — a INTERFACE da Oficina (passos 2-3, D-73): esqueleto de painéis (cena no centro, propriedades à direita, modos no topo, status embaixo) + a CÂ…
...
- `oficina.mjs` — oficina.mjs — a bancada da CÂMERA DO EDITOR + OVERLAY DA MALHA (Oficina, passos 2-3).
