...
126 arquivos (código `.js .mjs .cjs .ts .tsx .html` + docs `.md`).
...
- `moto.js` — moto — MOTOCICLETA FUTURISTA ESTILIZADA, 100% em PASSOS (nenhuma linha de geometria em JS: `construir` é só `executar`). É a peça da 1ª corrida do experiment…
