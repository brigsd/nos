...
- `som.html` — som.html — a ABA SOM. S2 (D-100) foi a CASCA: carregar um evento de pecas-som, DESENHAR a onda e TOCAR ao vivo. S3 (aqui) transforma o painel direito, que er…
