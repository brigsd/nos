 ...
 * Published rounds: D-36/37/38 (2026-07-17), D-39, D-40 (som), D-41, D-42 (brasa), D-44 (?res=), D-45 (render em camadas + billboards), D-46 (menu de gráficos), D-45p3 (blocos linha+pedra), D-47 (joystick + 3ª otim), D-48 (joystick 4 camadas), D-49 (billboards orientados), D-50 (profundidade + prancheta), D-50b (espessura fina), D-51 (PLANTA v1 + Santuário — this touch).
 *
